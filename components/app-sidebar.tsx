        ...
        <SidebarHeader>
          <div className="flex items-center justify-between">
            ...
            <Button
              variant="default"
              size="icon"
              className="size-8 bg-gradient-to-br from-pink-400 via-pink-500 via-purple-500 via-indigo-500 to-indigo-400 hover:from-pink-500 hover:via-pink-600 hover:via-purple-600 hover:via-indigo-600 hover:to-indigo-500 text-white font-bold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 hover:animate-none"
